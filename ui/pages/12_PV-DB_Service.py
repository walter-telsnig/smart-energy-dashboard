...
st.set_page_config(layout="wide", page_title="PV Production Service • Smart Energy Dashboard", page_icon="💹")
apply_global_style()

sidebar_nav(active="🗄️ PV Production • Service") 
...
production_kw = st.number_input(
    "Production Kilowatt:", key="production_kw_value", format="%0.5f"
)
